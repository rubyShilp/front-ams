...
export default {
  ...
  methods: {
    ...
    emptyData(classname, title) {
      var html =
        '<div style="padding:10px;"><span style="font-size: 18px;font-weight: bold;color: #2991d0;">' +
        title +
        '</span><span  style="position: absolute;top: 46%;left: 42%;color:#ccc; font-size: 20px;">暂无数据</span></div>';
