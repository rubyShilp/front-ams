    ...
    <div class="left-main-center">
      <div class="left-main-from-table">
        <div class="from-right">
          <el-form :inline="true">
            <el-form-item>
              <el-input placeholder="请输入班级名称" size="mini" v-model="initData.classname"></el-input>
            </el-form-item>
            <el-form-item>
       ...
       class="school_dialog"
       >
       <el-form class="form" :model="handleData" :rules="class_rules" ref="handleForm">
           ...
           <el-form-item label="班级名称" prop="classname" label-width="100px">
            <el-input v-model="handleData.classname" :disabled="type === 'detail'"></el-input>
           </el-form-item>
           <el-form-item label="班主任姓名" prop="teachername" label-width="100px">
            <el-input v-model="handleData.teachername" :disabled="type === 'detail'"></el-input>
           </el-form-item>
