<template>
  <div class="equipment-main">
    ...
    <el-main>
      <!-- 地图 -->
      <div id="map-container" style="width:80%;height:500px;"></div>
    ...
    <el-footer>
      <el-row type="flex" class="row-bg" justify="end" style="margin:14px 0 0 0;">
        <el-button type="" size="small" style="margin-left:20px;" @click="isfence=false">关闭</el-button>
