    ...
    <div class="left-main-center">
      <div class="left-main-from-table">
        <div class="from-right">
          <el-form :inline="true">
            <el-form-item>
              <el-input placeholder="请输入资源名称" size="mini"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <div class="table-border">
          ...
          >
            ...
            <el-table-column prop="morschtime" label="父节点ID" sortable>
            </el-table-column>
            <el-table-column prop="morhometime" label="资源路径" sortable>
            </el-table-column>
            <el-table-column prop="minschtime" label="资源状态" sortable>
            </el-table-column>
            <el-table-column prop="minhometime" label="资源类型" sortable>
            </el-table-column>
            <el-table-column prop="nightschtime" label="资源图标" sortable>
            </el-table-column>
