      ...
      <div class="left-main-from-table">
        ...
        >
          ...
          >
            ...
            >
              <el-input
                v-model="handleData.resourcename"
            ...
            >
              <el-select
                v-model="handleData.resourceparentcode"
                :disabled="type === 'detail'"
              >
                <el-option
                  v-for="item in parentIds"
                  :key="item.resourceparentcode"
                  :label="item.resourcename"
                  :value="item.resourceparentcode"
                >
                </el-option>
              </el-select>
            ...
            >
              <el-input
                v-model="handleData.resourceurl"
                :disabled="type === 'detail'"
              ></el-input>
            </el-form-item>
            <el-form-item
            ...
            >
              <el-select
                v-model="handleData.resourcestatus"
                :disabled="type === 'detail'"
              >
                <el-option
            ...
            >
              <el-select
                v-model="handleData.resourcetype"
                :disabled="type === 'detail'"
              >
                <el-option
                  v-for="item in types"
            ...
            >
              <el-input
                v-model="handleData.resourceicon"
                :disabled="type === 'detail'"
              ></el-input>
            </el-form-item>
          </el-form>
