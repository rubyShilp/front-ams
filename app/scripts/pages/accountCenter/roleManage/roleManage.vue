      ...
      <div class="left-main-from-table">
        ...
        <div class="table-border">
          ...
          >
            ...
            <el-table-column label="序号" prop="rolecode" align="center">
            </el-table-column>
            <el-table-column
              prop="rolename"
              label="角色名称"
            ...
            <el-table-column prop="rolestatus" label="角色状态" sortable>
            </el-table-column>
       ...
       class="school_dialog"
       >
       <el-form class="form" :model="handleData" :rules="role_rules" ref="handleForm" v-if="type !== 'roleEdit'">
           <el-form-item label="角色名称" prop="rolename" label-width="120px">
            <el-input v-model="handleData.rolename"></el-input>
           </el-form-item>
           <el-form-item label="角色状态" prop="rolestatus" label-width="120px">
       ...
       <div slot="footer" class="dialog-footer">
         <el-button size="small"  v-if="type!=='roleEdit'" @click="cancel('handleForm')">关闭</el-button>
         <el-button size="small" v-if="type==='roleEdit'" @click="close">关闭</el-button>
         <el-button v-if="type==='roleEdit'" size="small" @click="handle('roleEdit')">保存</el-button>
